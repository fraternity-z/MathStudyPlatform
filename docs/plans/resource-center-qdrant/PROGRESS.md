...
> 专项状态：`IN_PROGRESS`
> 当前阶段：P0-P4 已完成；P4 为已批准的本地准生产范围，外部上线另行安排
> 当前里程碑：M4 `DONE`（本地准生产验收）；P5 尚未启动
> 最后更新：2026-09-07
> 维护入口：[目录说明](README.md)
...
| 当前执行门 | P0-P4/M4 在各自批准范围通过；P5/P6 尚未启动 |
...
| R-007 | 代表性数据不足导致索引和参数结论失真 | 中 | `OPEN`（P5） | 当前 MVP 的 60 篇原创语料、100 条冻结查询、10 万容量及 5 次真实无答案问答均已验收。百万副本只记趋势，不外推教学效果或生产 SLO；真实教学数据和更大负例集在 P5 扩充 |
...
2. 下一开发阶段为 P5：处理资源预算、中文词法索引、更大规模调优和真实教学质量；P6 处理完整多租户与高可用。
