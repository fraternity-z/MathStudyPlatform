...
2026-09-07 补充：项目负责人选择先完成本地准生产演练、外部上线另行安排。D-009/D-010 在本地范围冻结为每日加密全量备份、RPO 24h/RTO 60m，以及三 TLS peer、3 shard/3 replica/write consistency 2、双 worker；本地验证已完成，规模与供应商边界见 [P4 验收](TEST-ACCEPTANCE-2026-09-07.md)。正式生产故障域、云对象版本/跨区和组织接入由外部上线单独验收，本条不改写上方历史记录。
